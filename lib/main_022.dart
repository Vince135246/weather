...
class _SWeatherReport {
  String strDataShow = "";
  String strStartTime_1 = "";
  String strEndTime_1 = "";
  String strStartTime_2 = "";
  String strEndTime_2 = "";
  String strStartTime_3 = "";
  String strEndTime_3 = "";
...
class _HomePageState extends State<HomePage> {
  List<_SWeatherReport> Reportlist = [];
  _SWeatherReport S_WeatherReport = _SWeatherReport();
  int i = 0;
  @override
  Widget build(BuildContext context) {
    return Flex(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        print(response.data);
                        strDataShow = response.data['records'].toString(); //3
                        i = 1;
                        setState(() {});
                      },
                    ),
